...
export default function Admin() {
    return (
        <div className="h-screen">
            ...
            <p><Link href="/admin/timeclerk" className="text-red-700">BUTTON:</Link> for time clerk - this section will add/del/edit the time card, we need to discuss the exact functionaility of this section</p>           
        </div>
    )
}